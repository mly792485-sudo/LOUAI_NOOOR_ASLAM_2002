...
export default function App() {
  ...
  }, [settings.country, settings.city, settings.calculationMethod, settings.latitude, settings.longitude, settings.adhanReminder, settings.azkarReminder, settings.prePrayerReminder, settings.preIqamaMinutes, settings.iqamaReminder, settings.fridayKahfReminder, settings.tahajjudReminder]);
